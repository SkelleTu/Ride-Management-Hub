...
import PassengerPrices from "@/pages/passenger/prices";
import PricesPublic from "@/pages/prices-public";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/precos" component={PricesPublic} />
