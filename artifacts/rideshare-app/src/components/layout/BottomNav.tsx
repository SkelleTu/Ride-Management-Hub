...
import { Home, Calendar, Clock, User, LayoutDashboard, Car, Shield, Radio, MapPin } from "lucide-react";
  ...
  if (selectedRole === "passenger") {
    return (
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-[1100] bg-card/95 backdrop-blur border-t border-border flex items-center safe-area-pb">
        ...
        <Link href="/passenger/prices" className={linkClass("/passenger/prices")}>
          <MapPin className={iconClass("/passenger/prices")} />
          Preços
        </Link>
